...
class BookingPress_Repeat_Holiday extends DateTime{
    ...
    public function freq($frequency)
    {
        ...
        throw new InvalidArgumentException("freq: Accepts " . rtrim(implode(", ", BookingPress_Valid_Holiday::$frequencies), ","));
    }
    ...
    public function wkst($weekDay)
    {
        ...
        throw new InvalidArgumentException("wkst: Accepts " . rtrim(implode(", ", BookingPress_Valid_Holiday::$weekDays), ","));
    }
