<!-- Company popup Start -->
<el-drawer custom-class="bpa-drawer__language-translate" :visible.sync="open_invoice_detail_translate_language">
	...
	<div class="bpa-dlt__body">
		...
		<div v-if="typeof invoice_language_fields_data !== 'undefined' && bookingpress_current_selected_lang == field_language_ind" v-for="(lang_fields, lang_field_key) in invoice_language_fields_data[field_language_ind]" class="bpa-bmw__block">
			<div class="bpa-mw__title">
				<h4 v-html="(typeof bookingpress_invoice_language_section_title !== 'undefined' && typeof bookingpress_invoice_language_section_title[lang_field_key] !== 'undefined')?bookingpress_company_language_section_title[lang_field_key]:''"></h4>
			</div>
				...
				<template>
					<div class="bpa-mw__form">
						<el-form-item v-for="(lang_field_data, lang_field_data_key) in lang_fields">
							...
							<el-input class="bpa-form-control"  v-model="invoice_language_data[field_language_ind][lang_field_data.save_field_type][lang_field_data_key]" :type="(lang_field_data.field_type == 'text')?'text':'textarea'" :rows="(lang_field_data.field_type == 'text')?1:30"  :placeholder="lang_field_data.field_label">
							</el-input>								
						</el-form-item>
					</div>
				</template>
	...
	<div class="bpa-dlt__footer">
		<el-button @click="open_invoice_detail_translate_language = false" class="bpa-btn bpa-btn--primary"><?php esc_html_e( 'Okay', 'bookingpress-multilanguage' ); ?></el-button>
	</div> 
</el-drawer>
