<!-- Service -->
<el-drawer custom-class="bpa-drawer__language-translate" :visible.sync="open_package_translate_language">
			...
			<div v-if="empty_selected_language == 0" v-for="(field_language, field_language_ind) in bookingpress_get_selected_languages">
				<div v-if="(typeof language_fields_data !== 'undefined' && bookingpress_current_selected_lang == field_language_ind && typeof language_fields_data[field_language_ind] !== 'undefined') " v-for="(lang_fields, lang_field_key) in language_fields_data[field_language_ind]" class="bpa-bmw__block">
					<div class="bpa-mw__title">
						<h4 v-html="(typeof bookingpress_package_language_section_title !== 'undefined' && typeof bookingpress_package_language_section_title[lang_field_key] !== 'undefined')?bookingpress_package_language_section_title[lang_field_key]:''"></h4>
					</div>
	...
	<div class="bpa-dlt__footer">
		<el-button @click="open_package_translate_language = false;" class="bpa-btn bpa-btn--primary"><?php esc_html_e( 'Okay', 'bookingpress-multilanguage' ); ?></el-button>
	</div> 
</el-drawer>
